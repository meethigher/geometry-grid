...
public class GeometryGridTest {
    ...
    public void testCreate() throws Exception {
        ...
        Geometry geometry = GeoUtils.toEPSG3857(GeoUtils.geomFromText(wkt));
...
//        String wkt = "LINESTRING(106.67105340852869 29.530636809322942,106.66803216986591 29.52328796943324)";
        ...
        Geometry epsg3857 = GeoUtils.toEPSG3857(GeoUtils.geomFromText(wkt));
        ...
        while (iterator.hasNext()) {
            newList.add(GeoUtils.toEPSG4326(GeoUtils.geomFromText(iterator.next())).toText());
            iterator.remove();
        }
